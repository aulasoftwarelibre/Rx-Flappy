    ...
    },
    {
      ...
      value: function hitTestPoint(point, sprite) {
        ...
        if (shape === "circle") {
          ...
          var _vx =
              point.x - sprite.x - sprite.width / 2 + sprite.xAnchorOffset,
    ...
    */
    ...
    },
    {
      ...
      value: function hitTestCircleRectangle(c1, r1) {
        ...
        if (
          c1y - c1.yAnchorOffset <
          r1y - Math.abs(r1.halfHeight) - r1.yAnchorOffset
        ) {
        ...
        //so it must be on the left or right side
          ...
          if (
            c1x - c1.xAnchorOffset <
            r1x - Math.abs(r1.halfWidth) - r1.xAnchorOffset
          ) {
            region = "leftMiddle";
          } else {
            region = "rightMiddle";
          ...
          //Is `a` not a sprite and does it have x and y properties?
            ...
            throw new Error(
              "I'm sorry, " +
                ...
                " and " +
                b +
                " cannot be use together in a collision test.'"
            );
          }
        }
